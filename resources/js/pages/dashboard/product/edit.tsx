...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: "Edit Data", href: "/product/edit" },
    ];
    ...
    _method?: string; // Method spoofing untuk Laravel
    ...
    interface EditProps {
    product: ProductData; // Data produk dari server (Inertia props)
    }

    export default function EditProduct({ product }: EditProps) {
    const [isSubmitting, setIsSubmitting] = useState(false);
    const [currentImage] = useState<string | null>(product?.image_path || null);
    ...
    const { data, setData, post, processing, errors, reset } =
        ...
        product_availables: product?.product_availables?.toString() || "",
        ...
        <div className="w-full mx-auto p-6">
            ...
            <form onSubmit={submit} className="space-y-6">
                ...
                <div>
                    ...
                    id="price"
                    onChange={(event) =>
                        handleNumberInput("price", event.target.value)
                    }
                    placeholder="0"
                    min="0"
                    step="1000"
                ...
                <Textarea
                    ...
                    onChange={(event) =>
                    setData("product_description", event.target.value)
                    }
                ...
                <div>
                    ...
                    onChange={(event) =>
                        handleNumberInput("product_availables", event.target.value)
                    }
                    placeholder="0"
                    min="0"
                ...
                <div>
                    ...
                    id="product_link"
                    onChange={(event) =>
                        setData("product_link", event.target.value)
                    }
                ...
                {currentImage && (
                    ...
                    <div className="w-24 h-24 border border-gray-200 rounded-md overflow-hidden bg-gray-50">
                        <img
                        src={
                ...
                <div className="text-xs text-gray-500 mt-1">
                    ...
                    {currentImage && " Kosongkan jika tidak ingin mengubah gambar."}
                </div>
