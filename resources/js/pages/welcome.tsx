...
export default function Welcome() {
    ...
    return (
        <>
            ...
            <div className="flex flex-col bg-[#FDFDFC] text-[#1b1b18] min-h-screen">
                {/* HEADER */}
                <header className="w-full bg-[#FFE760]">
                    <nav className="flex flex-wrap items-center justify-between px-10 py-2 max-w-screen">
                        <div>
                            <AppLogoIcon />
                        </div>
                        ...
                        <div className="flex flex-wrap gap-3">
                            {auth.user ? (
                                ...
                                <>
                                    <Link href={route('login')} className="font-justme text-lg px-3 py-1.5 hover:text-white">Home</Link>
                                    <Link href={route('register')} className="font-justme text-lg px-3 py-1.5">Discography</Link>
                                    <Link href={route('register')} className="font-justme text-lg px-3 py-1.5">Videos</Link>
                                    <Link href={route('register')} className="font-justme text-lg px-3 py-1.5">Merch</Link>
                                    <Link href={route('register')} className="font-justme text-lg px-3 py-1.5">Event & Tour Dates</Link>
                                    <Link href={route('register')} className="font-justme text-lg px-3 py-1.5">Contact</Link>
                                </>
                            )}
                        </div>
                    </nav>
                                ...
                                <div className='mt-5 flex gap-4 '>
                                    ...
                                    <Link href='' className='w-20 h-max text-white hover:text-black'>
                                        ...
                                        <g id="g3344" transform="matrix(1.25,0,0,-1.25,-240.25,333.85454)">
                                            ...
                                            <g>
                                                <path fill="currentColor" d="M241.8,184.1c-6.3,0-12.5,2.1-17.4,6.2c-5.9,5.1-9.4,12-9.9,19.5c-0.4,7.3,2,14.3,7,19.8
